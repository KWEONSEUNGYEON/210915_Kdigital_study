...
class MyApp(QWidget):
    ...
    def initUi(self):
        ...
        self.tableWidget.setItem(0, 1,QTableWidgetItem('승연'))
        self.tableWidget.setItem(0, 2, QTableWidgetItem('tmddus6396@naver.com'))
        self.tableWidget.setItem(0, 3, QTableWidgetItem('tksdl0806!'))
